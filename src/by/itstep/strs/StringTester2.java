...
//String Poll
        ...
        String text = "Java is a programming language originally developed by Sun Microsystems and released in 1995 as a core component " +
                ...
                "Java applications are typically compiled to bytecode which can run on any Java virtual machine (JVM) regardless of " +
                ...
                "As of May 2007, in compliance with the specifications of the Java Community Process, Sun made available most of" +
                " their Java technologies as Virtual Machine under the GNU General Public License. Others have also developed alternative" +
                " implementations of these Sun technologies, such as the GNU Compiler for Java and GNU Classpath.\n" +
                "\n" +
                "Java's design, industry backing and portability have made Java one of the fastest-growing and most widely used programming " +
                "languages in the modern computing industry.Template:Fact";
